...
All non-participant identifiable result are posted in: [`results/results_README.md`](results)

Scripts for machine learning model combining rare variant + common variants, CLI scripts to perform MAGMA, burden scoring, and PRScs on the UKB-RAP: [`scripts/scripts_README.md`](scripts)
